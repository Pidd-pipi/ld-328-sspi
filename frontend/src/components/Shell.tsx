...
import { DashboardOutlined, ShoppingOutlined, SafetyCertificateOutlined, HistoryOutlined, BarChartOutlined, TeamOutlined, BulbOutlined, UserOutlined, LogoutOutlined } from '@ant-design/icons';
...
const menuItems = [
  ...
  { key: '/disposals', icon: <SafetyCertificateOutlined />, label: '临期处置' },
